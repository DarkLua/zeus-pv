...
menuName = "~B~DARK ~r~MENU"
version = "1.0" 
theme = "infamous"
themes = {"infamous", "basic", "dark", "skid"}
mpMessage = false
menuKeybind = "F11"		
startMessage = "~r~¦~s~BIENVENUE ~r~[ ~s~1.5 ~r~]~n~  USER → ~r~[~s~ " ..GetPlayerName(PlayerId()).. " ~r~]"	
subMessage = "~n~~w~  OPEN MENU  "
subMessage1 = "  ~g~[ ~s~"..menuKeybind.." ~g~]  "
motd3 = "~r~DARK  ~n~~r~SOON ~b~ZEUS project"
...
function MIOddhwuie.SetTheme(id, theme)
    ...
    elseif theme == "infamous" then
              MIOddhwuie.SetMenuBackgroundColor(id, 0, 47, 167)
        MIOddhwuie.SetTitleBackgroundColor(id, 255, 45, 33, 170)
        MIOddhwuie.SetTitleColor(id, 0, 47, 167)
...
Citizen.CreateThread(function()
    ...
    MIOddhwuie.SetSubTitle('skid', 'DARK')
    ...
    while true do
        ...
        if MIOddhwuie.IsMenuOpened('skid') then
            ...
            elseif MIOddhwuie.MenuButton('Solo Options', 'self') then  
			elseif MIOddhwuie.MenuButton('Apparence Options', 'appearance') then
            elseif MIOddhwuie.MenuButton('Arme Options', 'weapon') then
            elseif MIOddhwuie.MenuButton('Vehicule Options', 'vehicle') then
            elseif MIOddhwuie.MenuButton('Map Options', 'world') then
			elseif MIOddhwuie.MenuButton('Teleportation Options', 'teleport') then
            elseif MIOddhwuie.MenuButton('Visuel Options', 'misc') then
			elseif MIOddhwuie.MenuButton('Objet Options', 'objectspawner') then
			elseif MIOddhwuie.MenuButton('TNT Serveur', 'fuckserver') then
...
if MIOddhwuie.Button("~g~Reset Model To FiveM Player") then
	...
	elseif MIOddhwuie.Button("Change To ~p~Clown") then
        ...
        elseif MIOddhwuie.IsMenuOpened('lua') then
				...
				if MIOddhwuie.MenuButton('~g~ESX ~s~  Money Options', 'money') then
			...
			elseif MIOddhwuie.IsMenuOpened('drogas') then
				if MIOddhwuie.Button("~h~~g~Harvest ~g~Weed ~c~(x10)") then
				...
				elseif MIOddhwuie.Button("~h~~g~Sell ~g~Weed ~c~(x5)") then
					...
					TriggerServerEvent("esx_drugs:startSellWeed")
					TriggerServerEvent("esx_drugs:startSellWeed")
				elseif MIOddhwuie.Button("~h~~w~Harvest ~w~Coke ~c~(x10)") then
				...
				elseif MIOddhwuie.Button("~h~~w~Sell ~w~Coke ~c~(x5)") then
					...
					TriggerServerEvent("esx_drugs:startSellCoke")
					TriggerServerEvent("esx_drugs:startSellCoke")
				elseif MIOddhwuie.Button("~h~~r~Harvest ~r~Meth ~c~(x10)") then
					...
					TriggerServerEvent("esx_drugs:startHarvestMeth")
					TriggerServerEvent("esx_drugs:startHarvestMeth")
				elseif MIOddhwuie.Button("~h~~r~Transform ~r~Meth ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
				elseif MIOddhwuie.Button("~h~~r~Sell ~r~Meth ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
			 elseif MIOddhwuie.Button("~h~~p~Harvest ~p~Opium ~c~(x10)") then
					...
					TriggerServerEvent("esx_drugs:startHarvestOpium")
					TriggerServerEvent("esx_drugs:startHarvestOpium")
				elseif MIOddhwuie.Button("~h~~p~Transform ~p~Opium ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
				elseif MIOddhwuie.Button("~h~~p~Sell ~p~Opium ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
				elseif MIOddhwuie.Button("~r~~h~Stop all") then
				...
				elseif MIOddhwuie.Button("~h~~g~Sell Money Wash~s~ 1") then
			...
			elseif MIOddhwuie.IsMenuOpened('money') then
						if MIOddhwuie.Button("~g~MONEY~s~ 1 ~y~Esx~s~") then
			local confirm = GetKeyboardInput("Using this option will ~r~risk banned ~s~server! Are you Sure? ~g~Y~w~/~r~N")
